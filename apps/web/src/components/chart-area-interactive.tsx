...
export function ChartAreaInteractive({
  ...
  readonly data: ReadonlyArray<SubmissionActivity>;
}) {
      ...
      <CardHeader>
        ...
        <CardDescription>
          <span className="hidden @[540px]/card:block">
            Abstracts and sessions over the last 3 months
          </span>
          ...
          <AreaChart data={filteredData}>
            <defs>
              <linearGradient id="fillAbstracts" x1="0" y1="0" x2="0" y2="1">
                <stop offset="5%" stopColor="var(--color-abstracts)" stopOpacity={1} />
                <stop offset="95%" stopColor="var(--color-abstracts)" stopOpacity={0.1} />
              </linearGradient>
