---
title: "Deployment"
description: "Self-host opensesh on Cloudflare Workers with Postgres, R2, and Hyperdrive."
---
...
<Callout title="Placement matters" type="warn">
...
<Callout title="ANTHROPIC_API_KEY is optional">
  Without it the app runs fine — the **Run AI review** button in Evaluation and the AI draft
  generator in Agenda simply stay disabled.
</Callout>
