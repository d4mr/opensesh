...
<img
  src="/guides/emails-light.webp"
  alt="Email delivery: every message the platform sent with type, subject, status, and timestamp"
  className="rounded-lg border dark:hidden"
/>
<img
  src="/guides/emails-dark.webp"
  alt="Email delivery: every message the platform sent with type, subject, status, and timestamp"
...
<img
  src="/guides/communications-light.webp"
  alt="The Communications page: campaign composer, history, templates, and the task reminder rule"
  className="rounded-lg border dark:hidden"
/>
<img
  src="/guides/communications-dark.webp"
  alt="The Communications page: campaign composer, history, templates, and the task reminder rule"
  className="hidden rounded-lg border dark:block"
/>
