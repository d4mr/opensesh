...
3. **Submission questions** — the questions about the talk itself (the _abstract_ section).
4. **Participant questions** — the questions about each speaker (the _participant_ section).
